...
Este libro digital de Wilfrido Gómez , Armando Huitzilt y Andrea Moctezuma tiene una [Licencia internacional Creative Commons Atribución-No Comercial-CompartirIgual 4.0](http://creativecommons.org/licenses/by-nc-sa/4.0/). 
...
El libro no solo enseña sobre herramientas para la investigación, también es producto de ellas. A lo largo de su desarrollo, utilizamos sistemas de IA generativa (principalmente Claude, ChatGPT y Gemini) como asistentes de escritura, revisión y estructuración de contenido: nos ayudaron a refinar argumentos, sintetizar literatura académica, generar ejemplos didácticos y mejorar la claridad de explicaciones técnicas. También empleamos Consensus y Elicit para la búsqueda y análisis de evidencia científica sobre el uso de IA en contextos académicos, mientras que Litmaps nos permitió visualizar las redes de citación y descubrir literatura relevante para enriquecer cada capítulo. Este enfoque integrado ejemplifica la metodología que promovemos: usar la IA de manera ética, transparente y rigurosa, siempre bajo supervisión humana. De esta forma, practicamos lo que enseñamos: aprovechar el poder de estas herramientas sin comprometer la integridad académica ni la calidad del trabajo intelectual.
